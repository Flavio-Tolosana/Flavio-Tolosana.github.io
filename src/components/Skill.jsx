...
const Skill = ({name}) => {
    const skills = [
        ...
        { logo: <BsFiletypeSql className="logo" style={{color: 'var(--color)'}}/>, alt: "SQL" },
        ...
        { logo: <SiExpress className="logo" style={{color: 'var(--color)'}}/>, alt: "Express" },
        { logo: <FaGithub className="logo" style={{color: 'var(--color)'}}/>, alt: "GitHub" },
